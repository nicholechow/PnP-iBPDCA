...
class StudentGrad(pl.LightningModule):
    ...
    '''
    def __init__(self, model_name, pretrained, pretrained_checkpoint, act_mode, DRUNET_nb, residual_learning,in_nc,out_nc):
        super().__init__()
...
class GradMatch(pl.LightningModule):
    ...
    def __init__(self, hparams):
        ...
        self.student_grad = StudentGrad(self.hparams.model_name, self.hparams.pretrained_student,
                                        ...
                                        self.hparams.DRUNET_nb, self.hparams.residual_learning,in_nc, out_nc)
